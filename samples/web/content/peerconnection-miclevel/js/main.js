...
var micLevelLabel = document.getElementById('micLevelLabel');
...
var localStream, pc1, pc2, localAudioTrack;
var micLevelTimer;
var sdpConstraints = {
  'mandatory': {
...
function call() {
  ...
  if (audioTracks.length > 0) {
      ...
      if (typeof localAudioTrack.micLevel !== 'undefined') {
          micLevelTimer = window.setInterval(function () {
              micLevelLabel.textContent = "Mic Level: #" + localAudioTrack.micLevel + " dBov";
          },
          500);
      }
  }
